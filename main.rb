...
puts @USERNAME
puts @PASSWORD
api_key = 'h6f073tafrlttauhn7ynf6ry'
...
# 		# mytestAccount = 80353922
# 		session = Session.new
# 		session.auth('urbanmooseapparel', 'Mikemeara1995')
...
#         response = open("https://openapi.etsy.com/v2/listings/#{listingid}/favored-by?api_key=h6f073tafrlttauhn7ynf6ry").read
...
# 		    db = SQLite3::Database.new "FavList.db"
...
#         db = SQLite3::Database.open "FavList.db"
...
# 					# puts @user_id
# 		        else 
# 		                @return = "Mailchimp Up to Date"
# 		        end
# 		    else 
# 		    	puts "Every thing upto date"
# 		    end
